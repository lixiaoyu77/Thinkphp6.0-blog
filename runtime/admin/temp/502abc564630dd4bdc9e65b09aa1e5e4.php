<?php /*a:2:{s:45:"C:\wamp64\www\blog\view\admin\auth\index.html";i:1660222942;s:46:"C:\wamp64\www\blog\view\admin\public\base.html";i:1660287691;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<!--搜索和表单-->
 <form action="<?php echo url('/admin/auth'); ?>" class="pb-3">
    <div class="form-row">
        ...
        <div class="col-auto">
            ...
            <a href="<?php echo url('/admin/auth/create'); ?>" class="btn btn-success">添加管理员</a>
        </div>
    </div>
</form>
...
<table class="table table-bordered"> 
    ...
    <tbody>
        ...
        <tr>
            ...
            <td ><?php echo htmlentities($obj['name']); ?></td>
            <td ><?php echo htmlentities($obj->roles); ?></td>
            ...
            <td class="text-center"> 
                <form action="<?php echo url('/admin/auth/'.$obj['id']); ?>" method="post">
                    ...
                    <a href="<?php echo url('/admin/auth/'.$obj['id'].'/edit'); ?>" class="btn btn-warning btn-sm  ">修改</a>
                </form>
            </td>
        </tr>
