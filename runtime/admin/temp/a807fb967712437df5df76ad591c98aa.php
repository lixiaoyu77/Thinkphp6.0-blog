<?php /*a:2:{s:48:"C:\wamp64\www\blog\view\admin\artical\index.html";i:1660229321;s:46:"C:\wamp64\www\blog\view\admin\public\base.html";i:1660287691;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<!--搜索和表单-->
<form action="<?php echo url('/admin/artical'); ?>" class="pb-3">
    <div class="form-row">
        ...
        <div class="col-auto">
            ...
            <a href="<?php echo url('/admin/artical/create'); ?>" class="btn btn-success">添加文章</a>
        </div>
    </div>
</form>
<!--数据列表--> 
<table class="table table-bordered"> 
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="text-center"><?php echo htmlentities($obj['tittle']); ?></td>
            <td class="text-center"><?php echo htmlentities($obj['authname']); ?></td>
            <td class="text-center"><?php echo htmlentities($obj['create_time']); ?></td>
            <td class="text-center"> 
                <form action="<?php echo url('/admin/artical/'.$obj['id']); ?>" method="post">
                    ...
                    <a href="<?php echo url('/admin/artical/'.$obj['id'].'/edit'); ?>" class="btn btn-warning btn-sm  ">修改</a>
                </form>
            </td>
        </tr>
